      ...
      <div className="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a aria-label="Instagram" href="https://www.instagram.com/progment_solution" target="_blank" rel="noreferrer" className="h-8 w-8 rounded-full bg-[oklch(0.60_0.18_20)] grid place-items-center hover:opacity-90 transition"><Instagram className="h-3.5 w-3.5" /></a>
          </div>
        </div>
      </div>
    </div>
